      ...
      <div className={styles.pageContainer}>
        <div className={styles.box1}>
          ...
          <div className={styles.button}>
            ...
            <button className={styles.btn2}> See how its Work</button>
          </div>
        ...
        <div className={styles.box2}>
          <Image className={styles.imag} src={pic} alt="#"></Image>
        </div>
      </div>
        ...
        <div className={styles.box3}>
          ...
          <div className={styles.txtcenter1}>
            <div className={styles.grey}>
              <Image className={styles.pic1} src={pic1} alt=""></Image>
            </div>
          </div>
        </div>
      ...
      <div className={styles.parent}>
        <div className={styles.box5}>
          <div className={styles.cardcentermain}>
            ...
            <button className={styles.cardbutton}>Get Free Consltancy</button>
          </div>
        </div>
